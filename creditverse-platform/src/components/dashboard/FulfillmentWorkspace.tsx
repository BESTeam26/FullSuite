...
export const FulfillmentWorkspace = () => {
  ...
  const handleStatusChange = (
    ...
    toast({
      ...
      description: `Work order ${woId} moved to ${status}. Sub-account notification sent!`,
    });
  };
    ...
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Incoming work orders from sub-accounts subscribed to HQ Done-For-You
            fulfillment.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 text-status-warning">
        ...
        <div className="text-xs">
          ...
          generated by subscriber sub-accounts auto-stream directly into this
      ...
      <div className="relative max-w-md">
        ...
        <Input
          placeholder="Search by client, sub-account, or work order ID..."
          value={search}
        ...
        <table className="w-full text-sm text-left">
          <thead className="border-b border-border bg-muted/40 text-xs uppercase text-muted-foreground">
            <tr>
              ...
              <th className="px-6 py-3 font-medium">Sub-Account</th>
                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        >
                          Mark Completed & Notify Sub-Account
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </div>
