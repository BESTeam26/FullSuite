...
export function AiWordingAssist({ body, onApply, disabled }: { body: string; onApply: (next: string) => void; disabled?: boolean }) {
  ...
  return (
    <div className="rounded-lg border border-border bg-background p-3">
      ...
      <p className="mt-1 text-[10px] text-muted-foreground">Rephrases what the letter already says, in the consumer's voice. It adds no facts and cites no law; you decide what to keep, and approval still passes the QA gate. Uses your organization's AI credits.</p>
