...
| CR-3 | Chronology layer | **PROPOSAL** — approval required. Now unblocked by CR-2: `reporting_period` and `account_information_date` already exist on the child table |
